...
> [!NOTE]
> This page documents *how the frontend is built*. For *how it should behave* — required screen states, permission-aware UI, chart honesty rules, and the personas each dashboard serves — see [Product Management Best Practices](../product/best-practices.md), particularly [UI & Interaction](../product/ui.md) and [Data Visualisation](../product/data-visualisation.md).

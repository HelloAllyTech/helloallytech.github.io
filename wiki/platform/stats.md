...
| What | Repo | Count |
|---|---|---|
| PostgreSQL entities | `ally-be` | 225 |
| TypeORM migrations | `ally-be` | 546 |
| Feature modules | `ally-be` | 72 |
| WebSocket gateways | `ally-be` | 7 |
| Weaviate collections | `ally-ai` | 6 |
| Weaviate migrations | `ally-ai` | 7 |
| API endpoint modules | `ally-ai` | 14 |
| Event types | `ally-ai-learn` | 10 |
| TTS / STT / LLM providers | `ally-ai-learn` | 13 |
| Numbered developer guides | `ally-ai-learn` | 12 |
| Applications | `ally-web` | 2 |
| Shared libraries | `ally-web` | 1 |

_Counted on 2026-09-21._
